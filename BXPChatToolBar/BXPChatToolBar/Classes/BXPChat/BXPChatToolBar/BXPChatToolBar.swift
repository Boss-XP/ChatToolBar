...
public class BXPChatToolBar: UIView, UITextViewDelegate, BXPChatFaceViewDelegate, BXPChatSoundsRecorderDeleagte, BXPChatMoreOptionViewDelegate {
    ...
    lazy private var chatFaceButton: BXPEditableButton = {
        var tempButton = BXPEditableButton()
        ...
        tempButton.buttonInputView = inputView

        return tempButton
    }()

    lazy private var chatMoreButton: BXPEditableButton = {
        var tempButton = BXPEditableButton()
